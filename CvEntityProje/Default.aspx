...
<body>
    <div class="sidenav text-center">
        <div class="side_top">
            <img src="web/images/about.jpg" alt="news image" class="web/img-fluid navimg">
            <h1 class="top_hd mt-2"><a href="index.html">Baran Karakaya</a></h1>
            <p class="top_hdp mt-2">Junior Backend Developer</p>
        </div>
        <!-- header -->
        <header>
            <div class="nav-top">
        ...
        <div class="banner-text-w3ls" id="home">
            <div class="container">
                <div class="mx-auto text-center">
                    ...
                    <a class="btn btn-primary mt-lg-5 mt-3 agile-link-bnr" href="#about" role="button">Hakkında</a>
                </div>
            </div>
        </div>
        <!-- about -->
